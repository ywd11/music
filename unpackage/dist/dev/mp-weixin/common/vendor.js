...
/***/ 102:
/*!*************************************************************************!*\
  !*** C:/Users/杨伟东/Documents/HBuilderProjects/hello-uni/util/plugins.js ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.textActive = exports.formatDate = exports.comuptNum = void 0;var comuptNum = function comuptNum(num) {
  var str = '';
  if (num < 10) {
    str = "00:0" + num;
...
//时间戳转换方法    date:时间戳数字
exports.comuptNum = comuptNum;var formatDate = function formatDate(date) {
...
// 高亮搜索条件
exports.formatDate = formatDate;var textActive = function textActive(searchValue, value) {
  var str;
  if (value && searchValue) {
    var _str;
    var keywords = searchValue.toLocaleUpperCase();
    var text = value.toLocaleUpperCase();
    var reg = new RegExp(keywords, 'g');
    var index = text.search(reg);
    if (index > -1) {
      var str1 = value.substr(index, keywords.length);
      _str = value.substring(0, index) + '<span style="color: blue;">' + str1 + '</span>' + value.substring(index +
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.myRequest = void 0;var BASE_URL;

console.log('微信小程序');
BASE_URL = "http://9aers4.natappfree.cc";
